...
export default function AccountMenu({
  ...
  return (
    <div ref={wrapperRef} className="fixed bottom-6 right-4 z-40 flex bg-white dark:bg-stone-800 rounded-xl p-0.5 border border-gray-200 dark:border-white/15 shadow-xl shadow-black/15 dark:shadow-black/50">
      <button
        type="button"
        onClick={() => setOpen((v) => !v)}
        aria-haspopup="menu"
      ...
      {open && (
        <div
          role="menu"
          className="absolute right-0 bottom-full mb-2 w-56 rounded-lg border border-gray-200 dark:border-white/15 bg-white dark:bg-stone-900 shadow-lg shadow-black/10 dark:shadow-black/40 overflow-hidden"
        >
