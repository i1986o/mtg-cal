...
export default function ShareButton({ title, url }: { title: string; url: string }) {
  ...
  return (
    <div ref={ref} className="relative">
      <button
        onClick={handleShare}
        className="inline-flex items-center gap-2 px-4 py-2.5 bg-white dark:bg-[#0c1220] text-gray-700 dark:text-gray-300 text-sm font-medium rounded-lg hover:bg-gray-50 dark:hover:bg-[#141c2e] transition border border-gray-100 dark:border-white/8 cursor-pointer"
      >
      ...
      {open && (
        <div className="absolute bottom-full mb-2 left-0 z-50 bg-white dark:bg-[#0c1220] border border-gray-100 dark:border-white/10 rounded-xl shadow-xl overflow-hidden min-w-[160px]">
          <button
            onClick={copyLink}
