...
export default function ShareButton({ title, url }: { title: string; url: string }) {
  ...
  return (
    <div ref={ref} className="relative">
      <button
        onClick={handleShare}
        className="inline-flex items-center gap-2 px-4 py-2.5 bg-white dark:bg-[#0c1220] text-gray-700 dark:text-gray-300 text-sm font-medium rounded-lg hover:bg-gray-50 dark:hover:bg-[#141c2e] hover:-translate-y-0.5 hover:shadow-md dark:hover:shadow-black/30 active:translate-y-0 transition-all duration-200 border border-gray-100 dark:border-white/8 cursor-pointer"
      >
