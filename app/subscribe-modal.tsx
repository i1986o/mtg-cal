  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center justify-center w-10 h-10 bg-white/10 text-gray-300 rounded-lg border border-white/15 hover:bg-white/15 hover:text-white transition cursor-pointer"
