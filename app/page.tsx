...
export default async function HomePage({
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-8">
      ...
      {/* Sticky filter bar */}
      <div className="sticky top-0 z-10 py-3 mb-6 bg-[#0d1117]/95 backdrop-blur-sm">
      ...
      {Object.entries(grouped).map(([date, dayEvents]) => (
        <div key={date} className="mb-6">
          <h2 className="sticky top-12 z-[5] bg-[#0d1117]/95 backdrop-blur-sm text-lg font-[family-name:var(--font-ultra)] font-bold text-gray-300 pb-2 mb-3 pt-2 -mx-4 px-4">
          ...
          <div className="space-y-2">
            {dayEvents.map((ev) => (
              <Link
                ...
                className="group block bg-[#131a2b] hover:bg-[#182035] border border-[#1e2a42] rounded-xl p-4 transition-all duration-200 cursor-pointer"
              >
