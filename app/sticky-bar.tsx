...
export default function StickyBar({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      <div
        className={`sticky top-0 z-10 py-3 mb-6 bg-gray-50 dark:bg-[#0c1220] transition-shadow duration-300 ${isStuck ? "shadow-[0_8px_30px_-10px_rgba(0,0,0,0.08)] dark:shadow-[0_8px_30px_-10px_rgba(0,0,0,0.3)]" : ""}`}
