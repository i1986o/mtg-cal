...
export default function StickyBar({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      <div
        ref={barRef}
        className={`sticky top-0 z-10 py-3 mb-6 bg-white dark:bg-stone-900 transition-shadow duration-300 anim-fade-in ${isStuck ? "shadow-[0_8px_24px_-10px_rgba(0,0,0,0.05)] dark:shadow-[0_8px_24px_-10px_rgba(0,0,0,0.18)]" : ""}`}
