...
function CommandCard({ name, summary, example }: { name: string; summary: string; example?: string }) {
  return (
    <div className="rounded-lg border border-gray-100 dark:border-white/10 bg-white dark:bg-[#0c1220] p-4">
      <div className="font-mono text-sm font-semibold text-indigo-600 dark:text-indigo-400">{name}</div>
        ...
        <div className="mb-8">
          {inviteUrl ? (
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-3 rounded-lg bg-indigo-600 hover:bg-indigo-700 text-white font-semibold text-base transition shadow-sm"
            >
