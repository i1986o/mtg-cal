...
function EmptyState({ inviteUrl }: { inviteUrl: string | null }) {
  return (
    <div className="bg-white dark:bg-[#0c1220] border border-gray-100 dark:border-white/8 rounded-xl p-6 space-y-3">
      ...
      <div className="pt-1 flex flex-wrap gap-2">
        {inviteUrl && (
          <a
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-md border border-gray-200 dark:border-white/15 hover:bg-gray-50 dark:hover:bg-white/5 text-gray-700 dark:text-gray-200 font-medium text-sm transition"
          >
