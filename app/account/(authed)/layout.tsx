 ...
 * homepage, and sub-pages (saved, events, sources, preferences) can use a
 * simpler focused layout. Navigation between account sections lives in the
 * top-right AccountMenu.
 */
