...
export default function AboutModal({ onClose }: { onClose: () => void }) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={onClose}>
      ...
      <div
        className="relative bg-white dark:bg-[#0e2240] rounded-xl shadow-2xl border border-gray-200 dark:border-[#1a3558] w-full max-w-lg p-6 space-y-4"
        ...
        <div className="space-y-3 text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <div className="flex items-center gap-3 pt-2">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-4 py-2 bg-gray-100 dark:bg-[#0e2240] text-gray-700 dark:text-gray-300 text-sm font-medium rounded-lg hover:bg-gray-200 dark:hover:bg-[#132c50] transition border border-gray-200 dark:border-[#1a3558]"
            >
              {"\u2B50"} GitHub
            </a>
          </div>
