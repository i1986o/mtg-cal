      ...
      <button
        ...
        className={`shrink-0 w-7 h-7 rounded-full flex items-center justify-center transition ${
          saved
            ...
            : "text-gray-400 hover:text-amber-500 hover:bg-gray-100 dark:hover:bg-neutral-800"
    ...
    <button
      ...
      className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-medium transition border ${
        saved
          ...
          : "bg-white text-gray-700 border-gray-300 hover:bg-gray-50 dark:bg-neutral-900 dark:text-gray-200 dark:border-neutral-700 dark:hover:bg-neutral-800"
      } ${busy ? "opacity-50" : ""} ${className}`}
    >
      <StarIcon filled={saved} />
      {label}
