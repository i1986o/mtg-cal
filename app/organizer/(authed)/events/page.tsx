  ...
  return (
    <div className="p-6 lg:p-8 max-w-7xl">
      ...
      {loading ? (
        ...
        <EventTable
          events={events}
          editHref={(id) => `/organizer/events/${encodeURIComponent(id)}/edit`}
          patchEndpoint={(id) => `/api/organizer/events/${encodeURIComponent(id)}`}
          deleteEndpoint={(id) => `/api/organizer/events/${encodeURIComponent(id)}`}
