...
export default function ScrapersPage() {
  ...
  return (
    <div className="p-6 lg:p-8 max-w-3xl">
      ...
      <section className="bg-white dark:bg-stone-900 border border-gray-200 dark:border-stone-700 rounded-lg p-5 mb-4">
      ...
      <section className="bg-white dark:bg-stone-900 border border-gray-200 dark:border-stone-700 rounded-lg p-5">
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="w-24 px-3 py-2 text-sm border border-gray-300 dark:border-stone-600 rounded-md bg-white dark:bg-stone-800 text-gray-900 dark:text-gray-100"
          />
          ...
          <button
            ...
            className="ml-3 text-xs px-3 py-1.5 rounded-md border border-gray-300 dark:border-stone-600 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-stone-800"
          >
            Save
          </button>
        </div>
