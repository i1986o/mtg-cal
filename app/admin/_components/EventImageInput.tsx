      ...
      {value ? (
        <div className="flex items-start gap-3">
          ...
          <img
            src={value}
            alt="Event preview"
            className="w-32 h-20 object-cover rounded-md border border-gray-200 dark:border-gray-700"
          />
        ...
        <button
          ...
          onClick={pick}
          disabled={busy}
          className="w-full sm:w-auto inline-flex items-center gap-2 px-4 py-2 rounded-md border border-dashed border-gray-300 dark:border-gray-600 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 disabled:opacity-50"
        >
