  ...
  return (
    <div ref={wrapperRef} className="relative">
      ...
      {showDropdown && (
        <ul
          role="listbox"
          className="absolute z-20 left-0 right-0 mt-1 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-md shadow-lg max-h-64 overflow-y-auto"
        >
          {matches.map((v, i) => (
            <li key={v.name} role="option" aria-selected={i === highlight}>
              <button
                ...
                className={`w-full text-left px-3 py-2 transition ${
                  i === highlight ? "bg-gray-100 dark:bg-gray-800" : "hover:bg-gray-50 dark:hover:bg-gray-800/70"
                }`}
              >
